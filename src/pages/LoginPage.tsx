    ...
    <div className="relative flex min-h-[100svh] bg-background">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <img
          ...
          alt="Yoga instructor flowing through a pose in a studio"
      ...
      <div className="relative flex w-full items-center justify-center px-4 py-8 lg:w-1/2">
        ...
        >
          {/* Brand header — mobile only (desktop has image panel) */}
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Sign in to manage your practice</p>
          </div>
